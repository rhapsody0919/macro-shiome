...
export const MARKET_QUESTIONS = {
  /**
   * 金利の水準と構造 (#219)。**「金融環境は緩いか」から切り出した。**
   *
   * 12 枚が 1 つの問いに集まり、全ページで最大になっていた。金利は「いまどこにあるか」を
   * 読む図で、環境指数や信用スプレッドは「緩いか厳しいか」を測る図。**目的が違う**ので、
   * 同じ見出しに並べると上流 → 下流の読み筋が長すぎて伝わらない。
   */
  rates: {
    title: '金利はどこにあるか',
    guide:
      '名目・実質・期間ごとの水準を見る。金利が高いと経済成長・企業業績・個人消費のすべてが抑制され、株式の理論値も下がる。',
  },
  financial: {
    title: '金融環境は緩いか厳しいか',
    guide:
      '金利の水準そのものではなく、資金の取りやすさを測る。政策・信用・国債の需給が揃って初めて「緩い」と言える。',
  },
  risk: {
    title: '市場は不安か',
...
export const JAPAN_QUESTIONS = {
  ...
  'jp-external': {
    title: '海外との取引は円を支えるか',
    guide:
      '輸入が高くなれば稼ぎは目減りし、経常黒字が細れば円は支えを失う。交易条件 (価格) が先に動き、収支に結果が出る。',
  },
  'jp-market': {
    title: '日本市場はどう動いているか',
